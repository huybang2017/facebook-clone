...
public interface PostRepository extends JpaRepository<Post, Long> {
  ...
  @Query("SELECT p FROM Post p WHERE p.content IS NOT NULL AND p.content <> ''")
  Page<Post> findAllByContentIsNotNullAndContentNot(String emptyString, Pageable pageable);
